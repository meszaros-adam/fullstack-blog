...
var render = function () {
  ...
  return _c("div", { staticClass: "menu_srch d-flex" }, [
    _c("i", {
      staticClass: "fas fa-search search_btn",
      on: {
    ...
    _vm.showSearch
      ? _c("div", { staticClass: "header_serch" }, [
          ...
          _c(
            "div",
            { staticClass: "header_serch_i", on: { click: _vm.searchBlog } },
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('search', (__webpack_require__(/*! ./components/search.vue */ "./resources/js/components/search.vue")["default"]));
