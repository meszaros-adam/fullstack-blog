				...
				<div class="row">
					<div class="cl-12 col-md-12 col-lg-9">
						<div class="blog_post_left">
							...
							@auth("bloguser")
							<commentsystem :comments="{{$blog->comment}}"  :user="{{Auth::guard('bloguser')->user()}}" :blogid="{{$blog->id}}"></commentsystem>
							@else
							<commentsystem :comments="{{$blog->comment}}"  :user="false" :blogId="{{$blog->id}}"></commentsystem>
							@endauth				
						</div>
					</div>
